...
/**
 * @param	internalUrl	array		The URL used to pull manifest from the server, keyed by dc id, asterisk means all dcs.
 * @param	encryptionKey	string		The key used to encrypt the URI (256 bits).
 * @param	encryptionIv	string		The iv used to encrypt the URI (128 bits).
 * @param	encryptionRegex	string		The regex used to match the encrypted part of the URI (according to the 'encrypt' named group).
 */
function KalturaDeliveryProfileForensicWatermark(){
	this.internalUrl = null;
	this.encryptionKey = null;
	this.encryptionIv = null;
	this.encryptionRegex = null;
}
KalturaDeliveryProfileForensicWatermark.inheritsFrom (KalturaDeliveryProfile);
...
KalturaDeliveryProfileVodPackagerPlayServer.inheritsFrom (KalturaDeliveryProfile);
...
/**
 * @param	watermarkId	int		.
 */
function KalturaForensicWatermarkAdvancedFilter(){
	this.watermarkId = null;
}
KalturaForensicWatermarkAdvancedFilter.inheritsFrom (KalturaSearchItem);
