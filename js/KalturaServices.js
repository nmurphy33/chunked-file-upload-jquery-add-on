 ...
 * @return	KalturaDropFolder.
 */
KalturaDropFolderService.prototype.freeExclusiveDropFolder = function(callback, dropFolderId, status, errorCode, errorDescription){
	if(!errorCode)
		errorCode = null;
	if(!errorDescription)
 ...
 */
KalturaScheduleEventService.prototype.getConflicts = function(callback, resourceIds, scheduleEvent, scheduleEventIdToIgnore){
